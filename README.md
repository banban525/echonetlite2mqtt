...
| `ECHONET_USER_CUSTOM_MRA_FOLDER` | `--echonetUserCustomMraFolder` | Specifies the folder path for user custom MRA files. (Default: not use) |
...
You can use a user-defined MRA by specifying a folder with the environment variable `ECHONET_USER_CUSTOM_MRA_FOLDER` ( `--echonetUserCustomMraFolder` ).

Example: For air conditioner (eoj=0x0130)
* for Docker: `-e ECHONET_USER_CUSTOM_MRA_FOLDER=/(your-folder)/MY_MRA/`
* for Node.js: `--echonetUserCustomMraFolder "/(your-folder)/MY_MRA/"`
